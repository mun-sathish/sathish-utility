...
public class Play extends Activity implements OnSharedPreferenceChangeListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
        ...
        if (isFirstTime()) {
            ...
            alert.setTitle("Hexaphone");

            alert.setMessage("Press, hold and drag on the hexagon boxes to play music. Try playing it on " +
                    "a vacation to cheer the peeps around you.\n\nCheck Menu -> Preferences for more Options\n\n" +
                    "Have Fun!!!");
