...
import com.sathish.sathishapp.R;
...
public class Diary extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.personaldiary);
        //sleep(6000);
        ...
        if (isFirstTime()) {
            ...
            alert.setTitle("Personal Diary");

            alert.setMessage("Make To Do list or anything you want to note at any particular date and it " +
                    "saves automatically, you can check back anytime.\n\nHave a Dumbling!!!");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.diaryyy, menu);
        return true;
    }
