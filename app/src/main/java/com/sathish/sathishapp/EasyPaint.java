	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case SHARE:
			...
			i.putExtra(Intent.EXTRA_SUBJECT,
					getString(com.sathish.sathishapp.R.string.share_title_template));
			i.putExtra(Intent.EXTRA_TEXT,
					getString(com.sathish.sathishapp.R.string.share_text_template));
			i.putExtra(Intent.EXTRA_STREAM, Uri.fromFile(screenshotPath));
			try {
				startActivity(Intent.createChooser(i,
						getString(com.sathish.sathishapp.R.string.toolbox_share_title)));
			} catch (android.content.ActivityNotFoundException ex) {
				Toast.makeText(this.getApplicationContext(),
						com.sathish.sathishapp.R.string.no_way_to_share,
